        ...
        <>
            <div className="flex items-center justify-between flex-row-reverse px-10 py-2">
                <div className="flex flex-col w-20">
                    ...
                    {showDropDown &&
                        <div className="relative z-10 bg-black divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-transparent">
                            <ul className="absolute bg-gray-700 rounded-md py-2 text-sm text-gray-700 dark:text-white" aria-labelledby="states-button">
                                <li>
